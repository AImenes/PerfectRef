...
def unifiable(pair):
    ...
    if isinstance(g1, AtomRole):
        ...
        # Return false if r1(x,y),r1(z,x), because it would reduce do r1(x,x)
        if (g1.var1.bound and g1.var2.unbound) and (g2.var2.bound and g2.var1.unbound) and (g1.var1.original_entry_name == g2.var2.original_entry_name):
            return False
        
        # Return false if r1(y,x),r1(x,z), because it would reduce do r1(x,x)
        if (g1.var2.bound and g1.var1.unbound) and (g2.var1.bound and g2.var2.unbound) and (g1.var2.original_entry_name == g2.var1.original_entry_name):
            return False
